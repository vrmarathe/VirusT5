...
df_alpha=df.loc[df["Variant"]=="delta"]
...
#     #import pandas as pd
#     df_predictions = pd.DataFrame({'Labels': decoded_labels, 'Predictions:':decoded_preds})
#     print(df_predictions.head())translation_nsp_alpha.py
#     df_predictions.to_csv("df_predictions.csv")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="translation_nsp_delta_final",
...
# Save to CSV
train_df.to_csv("metrics_translation_delta_4_epochs.csv", index=False)
