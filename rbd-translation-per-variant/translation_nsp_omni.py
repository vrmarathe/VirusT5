...
# Load the data
df = pd.read_csv("/mmfs1/projects/changhui.yan/vishwajeet.marathe/fine_tune/rbd_per_variant_nsp/RBD_valid_finetuning_nucleotides.csv")
...
df_alpha=df.loc[df["Variant"]=="omicron"]
...
print("I AM HERE !")
df_alpha.drop(['Lineage','GenS1','GenS2'], axis=1,inplace=True)

df_alpha['translation'] = df_alpha.apply(lambda row: {'Seq1': row['Seq1'], 'Seq2': row['Seq2']}, axis=1)

print("I AM HERE !!")

print(df_alpha.head())

df_alpha = df_alpha.drop(['Seq1', 'Seq2','Variant'], axis=1)

from datasets import Dataset

hf = Dataset.from_pandas(df_alpha)
...
tokenizer = tokenizer = AutoTokenizer.from_pretrained('/mmfs1/projects/changhui.yan/vishwajeet.marathe/fine_tune/rbd_per_variant_nsp/virusTrained100k')
...
checkpoint="/mmfs1/projects/changhui.yan/vishwajeet.marathe/fine_tune/rbd_per_variant_nsp/virusTrained100k"
...
#     #import pandas as pdtranslation_nsp_alpha.py
#     df_predictions = pd.DataFrame({'Labels': decoded_labels, 'Predictions:':decoded_preds})
#     print(df_predictions.head())
#     df_predictions.to_csv("df_predictions.csv")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="translation_nsp_omicron_final",
...
# Save to CSV
train_df.to_csv("metrics_translation_final_4_epochs_omni.csv", index=False)
