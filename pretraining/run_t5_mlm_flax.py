...
def main():
    ...
    print("Eval_batch Size:",eval_batch_size)
    
    num_train_steps = len(tokenized_datasets["train"]) // train_batch_size * num_epochs
    print("Length of tokenized Dataset- Train",len(tokenized_datasets["train"]))
    
    print("Number of training Steps:",num_train_steps)
    num_of_hosts = jax.process_count()
    current_host_idx = jax.process_index()
    
    print("Number of Hosts:",jax.process_count())
    print("Current Host IDX:",jax.process_index())
