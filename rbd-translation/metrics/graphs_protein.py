...
def count_differences_modified(seq1,seq2):
    ...
    seq1 = seq1.upper()
    seq2 = seq2.upper()
    #print("\n Sequence 1(Label) :",seq1,"Type:",type(seq1))
    #print("\n Sequence 2(Reference):",seq2,"Type:",type(seq2))
...
input_file = "/mmfs1/projects/changhui.yan/vishwajeet.marathe/fine_tune/metrics/comparision/aligned_sequences_prot.csv"
...
with open("/mmfs1/projects/changhui.yan/vishwajeet.marathe/fine_tune/metrics/comparision/GISAID_ref_genome_RBD_proteins.fasta") as handle:
...
with open(input_file, "r") as csvfile:
    ...
    for row in csv_reader:
        ...
        label_sequence = row["Labels_prot"]
...
with open(input_file, "r") as csvfile:
    ...
    for row in csv_reader:
        ...
        predicted_sequence = row["Predictions_prot"]
